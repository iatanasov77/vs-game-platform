...
export class BoardButtonsComponent implements OnInit, OnChanges
{
    ...
    @Input() clearGameSessionsVisible = false;
    @Input() debugContractBridgeAuctionVisible = false;
    ...
    @Output() onClearGameSessions               = new EventEmitter<void>();
