...
trait CardGameConnect
{
    protected function connectCardGameOwner(
    ...
    protected function connectCardGameOpponent(
        CardGameManager $manager,
        WebsocketClientInterface $webSocket,
        GamePlayer $gamePlayer,
        $playAi
    ...
    protected function reconnectCardGame(
        ?CardGameManager $manager,
        WebsocketClientInterface $webSocket,
        ...
        if ( $manager && self::MyPosition( $manager, $dbUser, $position ) ) {
    ...
    protected function isCardGameAlreadyStarted( CardGameManager $manager, $userId ): bool
    {
