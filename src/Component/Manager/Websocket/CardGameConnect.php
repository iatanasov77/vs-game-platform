...
{
    protected function connectCardGameOwner( $manager, $webSocket, $gamePlayer, $playAi ): void
    {
    ...
    protected function connectCardGameOpponent( $manager, $webSocket, $gamePlayer, $playAi ): void
    {
