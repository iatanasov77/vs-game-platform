...
export const GameProvider = ({
    ...
    const AnnounceSymbols = [
        { id: Announce.CLOVER, key: "btnClover", value: <img src="/build/game-platform-reactjs/images/icons/Suites/clover.png" width="40" height="40" style={{ verticalAlign: "inherit" }} /> },
        { id: Announce.DIAMOND, key: "btnDiamond", value: <img src="/build/game-platform-reactjs/images/icons/Suites/diamond.png" width="40" height="40" style={{ verticalAlign: "inherit" }} /> },
        { id: Announce.HEART, key: "btnHeart", value: <img src="/build/game-platform-reactjs/images/icons/Suites/hearts.png" width="40" height="40" style={{ verticalAlign: "inherit" }} /> },
        { id: Announce.SPADE, key: "btnSpade", value: <img src="/build/game-platform-reactjs/images/icons/Suites/symbol-of-spades.png" width="40" height="40" style={{ verticalAlign: "inherit" }} /> },
