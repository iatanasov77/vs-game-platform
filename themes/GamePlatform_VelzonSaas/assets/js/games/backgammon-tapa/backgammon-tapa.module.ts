...
import { BackgammonTapaComponent } from './backgammon-tapa.component';
...
@NgModule({
    ...
    bootstrap: [BackgammonTapaComponent],
    providers: [
...
export class BackgammonTapaModule { }
