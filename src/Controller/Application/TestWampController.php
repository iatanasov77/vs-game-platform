...
class TestWampController extends AbstractController
{
    ...
    public function client1( Request $request ): Response
    {
        ...
        return $this->render( 'Pages/WampTest/client_1.html.twig', [
    ...
    public function client2( Request $request ): Response
    {
        ...
        return $this->render( 'Pages/WampTest/client_2.html.twig', [
            'clientSettings'    => $clientSettings,
        ]);
    }
